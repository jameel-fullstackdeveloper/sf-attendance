                        ...
                        <div class="row">
                            ...
                            <div class="media">
                                <div class="media-body">
                                 <h5 class="text-truncate" style="font-size:15px;color:#495057;text-transform: uppercase;">{{$val->employee->emp_firstname}} {{$val->employee->emp_lastname}}</h5>
                                    <span class="text-warning">{{$val->employee->department->dept_name}}</span>
                            ...
                            <hr/>
                                ...
                                <span class="" <?php if($val->workstate==1) { echo 'style="color:red"'; } else { echo  'style="color:green"';} ?> >
